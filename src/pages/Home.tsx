        ...
        <>
            ...
            <div className={STYLE['work--projects']}>
                <div className={STYLE['work--projects-grid']}>
                    ...
                    <CaseItem title="Scabtik rebranding" description='Website rebranding for an upcoming Hardstyle artist.' image={ImageScabtik2022} link="/scabtik-2022" gradientBeginColor="rgb(171, 129, 95)" gradientEndColor="rgb(30, 30, 30)" />
